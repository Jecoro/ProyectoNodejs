document.addEventListener('DOMContentLoaded', function () {
    ...
    if (valorNombre != '') {
      if (!regex.test(valorNombre)) {
        document.getElementById('errores').innerHTML =
          '<p>Introduce un nombre adecuado(solo se permiten letras)</p>';
  ...
  function validarApellidos() {
    ...
    if (valorApellidos != '') {
      if (!regex.test(valorApellidos)) {
        document.getElementById('errores').innerHTML =
          '<p>Introduce apellidos adecuados(solo se permiten letras)</p>';
  ...
  function validarFecha() {
    ...
    if (fecha != '') {
      if (!regex.test(fecha)) {
        document.getElementById('errores').innerHTML =
          '<p>El formato de fecha aceptado es: 01/01/2013, 5-3-2013</p>';
  ...
  function validarTelefono() {
    ...
    if (telefono != '') {
      if (!regex.test(telefono)) {
        document.getElementById('errores').innerHTML =
          '<p>El formato del  teléfono no es correcto (666 666 666)</p>';
